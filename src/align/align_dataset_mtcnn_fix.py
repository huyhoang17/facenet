...
def main(args):
    ...
    dataset = facenet.get_min_images_per_label_dataset(
        args.input_dir,
...
def parse_arguments(argv):
    ...
    parser.add_argument(
        '--min_images_per_label', type=int,
        help='Image size (height, width) in pixels.', default=3
    )
    parser.add_argument(
        '--max_images_per_label', type=int,
        help='Image size (height, width) in pixels.', default=20
    )
    parser.add_argument(
