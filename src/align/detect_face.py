...
def detect_face(img, minsize, pnet, rnet, onet, threshold, factor):
    ...
    # fastresize: resize img from last scale
    # (using in high-resolution images) if fastresize==true
    factor_count = 0
