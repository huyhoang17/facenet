...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        image_batch, label_batch = facenet.read_and_augment_data(
            image_list, image_indices, args.image_size, args.batch_size,
...
def parse_arguments(argv):
    ...
    parser.add_argument(
        'model_file', type=str,
        help='File containing the frozen model in protobuf (.pb) format to use for feature extraction.'  # noqa
    )
    parser.add_argument(
